...
exports.resources = JSON.parse(require('fs').readFileSync('AuthServer/json/Resources.json', 'utf8')).resources
...
exports.resource = JSON.parse(require('fs').readFileSync('ProtectedResource/json/Data.json', 'utf8'))
